...
- [[[userman-osmosmlc]]] Osmocom Project: OpenSMLC User Manual.
...
- [[[3gpp-ts-23-032]]] 3GPP TS 23.032: Universal Geographical Area Description
  (GAD)
...
- [[[3gpp-ts-43-059]]] 3GPP TS 23.059: Location Services (LCS) in GERAN
...
- [[[3gpp-ts-49-031]]] 3GPP TS 49.031: Location Services (LCS); Base Station
